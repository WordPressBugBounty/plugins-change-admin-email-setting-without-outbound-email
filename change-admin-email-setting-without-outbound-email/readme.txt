...
## Usage
Once activated, an administrator can change the admin email from the Settings >> General page. You can request a test email be sent to the new email address. The test email is sent from our servers. You can view our privacy policy here: at https://generalchicken.guru/privacy-policy-2/ .
